// ==UserScript==
// @name         WikiPlus
// @namespace    http://dev.wikia.com/wiki/MediaWiki:WikiPlus/code.js?action=edit
// @version      0.1
// @description  WikiPlus is a script that adds "Show/Hide Talk" and "Show/Hide Edits" to Special:WikiActivity. I may expand it to add more functionality later.
// @author       Charles Terry,
// @match        http://*.wikia.com/wiki/Special:WikiActivity
// @grant        none
// ==/UserScript==
